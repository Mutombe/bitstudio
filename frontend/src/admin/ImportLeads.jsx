...
export default function ImportLeads({ onDone }) {
    ...
    return (
      <div data-testid="import-result">
        <ul className="space-y-2 text-sm mb-5">
          <li><span className="text-[#4B9E6B] font-semibold text-lg tabular-nums mr-2">{result.created}</span> created</li>
          ...
          {result.errors.length > 0 && (
            <li>
              ...
              <ul className="mt-1 ml-5 list-disc text-xs text-bone-100/50 space-y-0.5">
  ...
  return (
    <form onSubmit={submit}>
      <p className="text-sm text-bone-100/55 mb-4">
      ...
      <input
        ...
        className="block w-full text-sm text-bone-100/70 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border file:border-white/15 file:bg-transparent file:text-bone-100 file:text-xs file:cursor-pointer"
      />
