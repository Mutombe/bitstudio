  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="border border-white/10 rounded-sm p-5 bg-maroon-950/20">
  ...
  return (
    <div className="border border-white/10 rounded-sm overflow-hidden">
      {Array.from({ length: rows }).map((_, r) => (
        <div key={r} className="flex items-center gap-4 px-4 py-3.5 border-b border-white/5">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-4">
      {Array.from({ length: columns }).map((_, c) => (
        <div key={c} className="rounded-sm border border-white/10 p-3 min-h-[40vh] bg-maroon-950/20">
          <Skeleton className="h-3 w-24 mb-4" />
          <div className="space-y-3">
            {Array.from({ length: (c % 3) + 1 }).map((_, i) => (
              <div key={i} className="rounded-sm border border-white/10 p-3">
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="border border-white/10 rounded-sm p-5 bg-maroon-950/20 h-fit">
          <Skeleton className="h-2.5 w-20 mb-4" />
